            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (resource && actionCreators[crudAction + 'Start']) {
                        if (relations && (actionName === 'update' || actionName === 'create')) {
                            ...
                            dispatch(redux_batched_actions_1.batchActions(actions_1));
                        }
                        else {
                ...
                case 3:
                    ...
                    if (!relations || (crudAction !== 'fetch' && crudAction !== 'update')) {
                        ...
                        dispatch(redux_batched_actions_1.batchActions(actions_2));
                    }
...
function createSelectors(mountPoint) {
    ...
    return {
        ...
        findByCid: function (state, cid) {
            return find_1.default(getLocalState(state).records, function (item) { return item._cid === cid; });
        },
        /**
         * @inheritdocs
         */
 ...
 */
exports.createReducer = function (resourceName, actionNames) {
    var recordReducer = redux_crud_1.default.Map.reducersFor(resourceName);
 ...
 */
exports.createActionCreators = function (resourceName) {
    var rawActionCreators = redux_crud_1.default.actionCreatorsFor(resourceName);
...
function createAPIResource(_a) {
    ...
    var actionCreators = exports.createActionCreators(resourceName);
    var selectors = createSelectors(resourceName);
    var actionNames = redux_crud_1.default.actionTypesFor(resourceName);
    var apiResource = {
        thunks: {},
        actions: actionCreators,
        actionNames: {},
        selectors: selectors,
        reducers: exports.createReducer(resourceName, actionNames)
    };
