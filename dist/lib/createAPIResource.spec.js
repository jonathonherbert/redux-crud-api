...
modelResourceWithTransforms = createAPIResource_1.default({
    resourceName: resourceName,
    baseUrl: baseUrl,
    options: { transformIn: transformIn, transformOut: transformOut }
});
actionCreators = createAPIResource_1.createActionCreators(resourceName);
// Normalised data
relationActionCreators = createAPIResource_1.createActionCreators(resourceName);
